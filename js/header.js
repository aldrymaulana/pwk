$(document).ready(function(){
	...
	$("ul.submenu2").parent().append("<span></span>");
	...
	$("ul.menu li span").click(function() { //Al hacer click se ejecuta...
		...
		$(this).parent().find("ul.submenu2").slideDown('fast').show(); //Menu desplegable al hacer click

		$(this).parent().hover(function() {
		}, function(){
			$(this).parent().find("ul.submenu2").slideUp('slow'); //Ocultamos el submenu cuando el raton sale fuera del submenu
		});
