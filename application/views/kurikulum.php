            ...
            <div class="container">
                <div class="clearfix">
                    <div class="grid9 first">
						...
						<p align ="justify">Mata kuliah inti yang akan diberikan selama masa perkuliahan adalah</p>
						<ol type="1" start="1">
							<li>Teori dan proses perencanaan</li>
							<li>Perencanaan wilayah dan kota</li>
							<li>Prasarana wilayah dan kota</li>
							<li>Ekonomi wilayah dan ekonomi kota</li>
							<li>Transportasi</li>
							<li>Manajemen perkotaan</li>
							<li>Perancangan kawasan pesisir</li>
							<li>Perancangan kota</li>
							<li>Analisis perencanaan</li>
						</ol>
						<br><br>
						<h4>KURIKULUM</h4><br>
