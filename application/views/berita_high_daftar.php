...
<html lang="en">
    <head>
        <title>Daftar Berita - Website Resmi Program Studi Perencanaan Wilayah dan Kota ITS</title>
        <meta charset="utf-8">
            ...
            <div class="container">
                <div class="clearfix">
                    <div class="grid9 first">
                        <h2><strong>Daftar Berita Highlights</strong></h2>
                        <style type="text/css">
                            .isitabel
                            {
                                border-width: 1px;
                        ...
                        <table border="5" class="isitabel">
                            <tr>
                                <th width="25px">No.</th>
                                <th width="700px">Judul Berita Highlights</th>
                            </tr>
                            <?php
                            $no=1;
